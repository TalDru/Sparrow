<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CompanySignUp.aspx.cs" Inherits="_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" Runat="Server">
        ...
        <asp:Table ID="Register_Tbl" CssClass="Tbl" runat="server" Height="82px">
            ...
            <asp:TableRow>
            <asp:TableCell>
            <asp:Label ID="Name" runat="server" Text="Company Name:"></asp:Label>
            ...
            <asp:TableCell>
            <asp:RequiredFieldValidator ID="RFV_Name" runat="server" ErrorMessage="Required Field" ControlToValidate="NameText" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
